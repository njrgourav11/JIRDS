      ...
      <div className="px-4 pt-16 mx-auto max-w-screen-xl md:px-24 lg:px-8">
        <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-2 text-sm">
            <p className="text-base font-bold tracking-wide text-orange-800">
              Contacts
            </p>
            <div className="flex">
          ...
          <div>
            <span className="text-base font-bold tracking-wide text-orange-800">
              Social
            </span>
      ...
      <div class="absolute top-full left-0 w-full h-full rounded-full bg-green-400 z-0 transition-all duration-500 group-hover:top-0"></div>
        ...
        <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
          <p className="text-sm text-black">
            ...
            <br />
            <a href="https://github.com/njrgourav11" target='_blank'>Designed and Managed by <u> Gourav</u></a>
          </p>

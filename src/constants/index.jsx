...
export const navItems = [
  ...
  { label: "Consultation", href: "/dr-anuradha" },
];
...
export const testimonials = [
  ...
  {
    user: "Sriperumbhuburi Geetha",
    company: "14 May, 2024",
    text: "Fantastic school! The teachers are extremely dedicated, caring, well organized, and I am happy that I chose this school.Responsible and cooperative staff. Always willing to help parents",
  },
  {
    user: "Krystal Gayathri",
    company: "11 Nov, 2018",
    text: "Trusted one for sure.. Witnessed many cases with postive results.. Very friendly and intercative doctor.",
  },
  {
    user: "Basha",
    company: "29 Dec,2018",
...
export const features = [
  {
    ...
    description:
      "Implement early intervention strategies for children's development, utilizing specialized techniques and tools to address developmental delays proactively.",
  },
  {
    icon: <School />,
    text: "Special education",
    description:
      "Tailored educational approaches for students with special needs, ensuring inclusivity and accessibility across different learning environments and platforms.",
  },
  {
    icon: <Stethoscope />,
  ...
  },
  {
    ...
    description:
      "Deliver counselling and training programs for parents and caregivers, promoting understanding and empowerment in managing their children's needs effectively.",
  },
  {
    icon: <Headset />,
  ...
  },
  {
    ...
    description:
      "Through community outreach, we strive to build bridges of understanding and solidarity, enriching lives and strengthening the fabric of our society",
  },
];
